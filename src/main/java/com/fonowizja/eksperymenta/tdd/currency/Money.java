package com.fonowizja.eksperymenta.tdd.currency;
...
@AllArgsConstructor
@ToString
public class Money implements Expression //TODO usunąć implements Expresion
{
    ...
    /**
     * @param multiplier multiplies ammount of given money
